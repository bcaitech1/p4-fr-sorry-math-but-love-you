...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="checkpoint",
        default=[
            "/opt/ml/ensemble/log/satrn_fold-0-0.8148.pth",
            "/opt/ml/ensemble/log/satrn-fold-1-0.8149.pth",
            "/opt/ml/ensemble/log/satrn-fold-2-0.8171.pth",
            "/opt/ml/ensemble/log/satrn-fold-3-0.8136.pth",
            "/opt/ml/ensemble/log/satrn-fold-4-0.8131.pth",
            "/opt/ml/ensemble/log/aster-fold-0-0.7878.pth",
            "/opt/ml/ensemble/log/aster-fold-1-0.7869.pth",
            "/opt/ml/ensemble/log/aster-fold-2-0.7900.pth",
            "/opt/ml/ensemble/log/aster-fold-3-0.7861.pth",
